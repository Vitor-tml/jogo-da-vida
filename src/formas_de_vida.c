...
// Testar se precisa incluir a funcoes.h aqui
...
void inicSapo(char **m, int nL, int nC)
{
    ...
    char padrao[2][4] = {{VAZ, ORG, ORG, ORG},
                        {ORG, ORG, ORG, VAZ}};
    int i, j, xInic = nL / 2, yInic = nC / 2;
...
{
    char padrao[4][5] = {{VAZ, ORG, VAZ, VAZ, ORG}, 
                        {ORG, VAZ, VAZ, VAZ, VAZ}, 
                        {ORG, VAZ, VAZ, VAZ, ORG}, 
                        {ORG, ORG, ORG, ORG, VAZ}};
    int i, j, xInic, yInic;
